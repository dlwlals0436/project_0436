...
if __name__ == '__main__':
    ...
    while True:
        ...
        post = soup.find("li", {"class" : "list-item"})
        post_num = post.find("div", {"class" : "wr-num hidden-xs"}).text



        if latest_num != post_num :
            latest_num = post_num
            name =  post.find("span", {"class" : "member"}).text
            ago =  post.find("div", {"class" : "wr-date hidden-xs"}).text
